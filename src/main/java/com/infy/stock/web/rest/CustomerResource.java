...
import com.infy.stock.web.rest.errors.BadRequestAlertException;
import com.infy.stock.web.rest.util.HeaderUtil;
...
@CrossOrigin(origins = "*", allowedHeaders = "*") public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "stockCustomer";
